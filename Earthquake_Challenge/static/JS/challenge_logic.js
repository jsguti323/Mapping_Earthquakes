...
// Add layer groups for earthquake, tectonic plate, and major earthquake data.
let allEarthquakes = new L.LayerGroup();
let plateData = new L.LayerGroup();
let majorQuakeData = new L.LayerGroup();

// Add a reference to the new groups to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tectonic Plates": plateData,
  "Major Earthquakes": majorQuakeData
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson").then(function(data) {
    ...
    // Creating a GeoJSON layer with the major earthquake data.
    L.geoJson(data, {
      ...
      // Create a popup for th circle to display magnitude and location.
      onEachFeature: function(feature, layer) {
        layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
      }
    }).addTo(majorQuakeData);

    // Add the major earthquakes layer to the map.
    majorQuakeData.addTo(map);
...
d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
  ...
  // Add tectonic plate data to our map.
  plateData.addTo(map);
